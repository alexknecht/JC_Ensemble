...
options = {
    ...
    'mp_head_node':('node1631.palmetto.clemson.edu', 'node1631', '10.125.7.101', 'node1631-ib0.palmetto.clemson.edu', 'node1631-ib0', '10.128.7.101'),
    'mp_host_list':(('node1631.palmetto.clemson.edu', 4),),
    'mp_mode':MPI,
    ...
    'thermal':OFF,
    'tmpdir':'/local_scratch/slurm.3240120',
    'tracer':OFF,
